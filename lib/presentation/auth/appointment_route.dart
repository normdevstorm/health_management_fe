...
@TypedShellRoute<AppointmentRoute>(
  routes: [
    ...
    TypedGoRoute<AppointmentDetails>(
...
class AppointmentDetails extends GoRouteData {
  final String appointmentId;
  AppointmentDetails({required this.appointmentId});
  @override
  Widget build(BuildContext context, GoRouterState state) {
    PrescriptionEntity? prescription = state.extra as PrescriptionEntity?;
    return BlocProvider(
      create: (context) => PrescriptionAiAnalysisBloc(prescriptionAiAnalysisUseCase: getIt()),
